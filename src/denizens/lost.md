...
title: Lost
designation: DENIZEN_03 — LOST
clearance: PUBLIC
eyebrow: Escaped From Arcadia Into a Broken Dreaming
order: 3
---
...
| Seeming | Nature |
|---|---|
| **[Beast](/denizens/lost/beast/)** | The animal-touched — claws, instincts, and a relationship with the wild that serves them well outside the walls. |
| **[Darkling](/denizens/lost/darklings/)** | Children of shadow and secrets, at home in darkness and deception. |
| **[Elemental](/denizens/lost/elementals/)** | Shaped by fundamental forces — fire, stone, water, wind. Often the physical backbone of Lost operations. |
| **[Fairest](/denizens/lost/fairest/)** | The most visibly Fae-touched — beautiful, compelling, dangerous. Standing out can get you killed, so Fairest learn to control their presence carefully. |
| **[Ogre](/denizens/lost/ogres/)** | Massive, powerful, and often underestimated. Carry Arcadia's cruelty in their bodies and use it as armor. |
| **[Wizened](/denizens/lost/wizened/)** | Crafters, tinkerers, and the clever — survived Arcadia by being useful, and continue that practice here. |
...
<p class="eyebrow">See also: <a href="/factions/">The Lost Mirror</a> · <a href="/character-creation/">Character Creation Guide</a></p>
